			...
			<div class="department_container">
				<div class="container ">
					<div class="heading_container heading_center">
						<h2>치료자·공동격리자를 위한 공지사항</h2>
						<p>
							상담문의가 필요하신 경우 전담공무원·지역보건소로 전화주시기 바랍니다<br> This is a notice
							for the therapist and the joint quarantine<br>
						</p>
					</div>
